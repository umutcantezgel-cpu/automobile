    ...
    modules: [
      {
        ...
        items: [
          { label: 'Übersicht aller Fahrzeuge', included: true },
          { label: 'Einfache Suchfunktion & Filter', included: true },
          { label: 'Detaillierte Einzelseiten pro Auto', included: true },
          { label: 'Mobile.de / AutoScout24 Verbindung', included: false, detail: 'Autos müssen von Hand eingetragen werden' },
        ],
      },
      {
        icon: <Target size={16} />,
        title: 'Mehr Anfragen',
        items: [
          { label: 'Formular für Probefahrten', included: true },
          { label: 'Anfrage zur Inzahlungnahme', included: true },
          { label: 'Sofort-Anruf Buttons am Handy', included: true },
      ...
      },
      {
        ...
        items: [
          { label: 'Hochwertiges Autohaus-Design', included: true, detail: 'Sieht nicht aus wie ein Baukasten' },
          { label: 'Perfekt für Handys optimiert', included: true },
          { label: 'Passend zu Ihren Firmenfarben', included: true },
          { label: '1 Design-Vorschlag', included: true },
        ],
      },
      {
        icon: <Search size={16} />,
        ...
        items: [
          { label: 'Regionale Sichtbarkeit bei Google', included: true },
          { label: 'Eintrag bei Google Maps', included: true },
          { label: 'Standort- & Routenplanung', included: true },
          { label: 'Extra Google-Sichtbarkeit für Fahrzeuge', included: false },
        ],
      },
      {
        icon: <Code2 size={16} />,
        ...
        items: [
          ...
          { label: 'Rechtssicher (Cookie-Hinweis)', included: true },
          { label: '3 Monate Hilfe nach Start', included: true },
          { label: 'Pflege-Vertrag zubuchbar', included: true },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        title: 'Autos & Daten',
        items: [
          { label: 'Automatischer Mobile.de Import', included: true, detail: 'Direkte Verbindung' },
          { label: 'Erweiterte Auto-Suche', included: true },
          { label: 'Hochwertige Detailseiten pro Auto', included: true },
          { label: 'Autos werden bei Google besser gefunden', included: true },
        ],
      },
      {
        ...
        items: [
          { label: 'Eingebauter Finanzierungs-Rechner', included: true },
          { label: 'Interaktive Inzahlungnahme', included: true },
          { label: 'Anfragen landen direkt beim Verkäufer', included: true },
          { label: 'Merkliste für Kunden', included: true },
          { label: 'Verbindung zur Kundenverwaltung', included: true },
        ],
      },
      {
        icon: <Palette size={16} />,
        ...
        items: [
          { label: 'Erscheinungsbild wie Premium-Marken', included: true },
          { label: '3 Design-Vorschläge', included: true },
          { label: 'Fließende Übergänge (wirkt teuer)', included: true },
          { label: 'Verkaufsfördernde Videos im Hintergrund', included: true },
        ],
      },
      {
        icon: <Search size={16} />,
        title: 'Nummer 1 in der Region',
        items: [
          { label: 'Sichtbar für 50+ wichtige Suchbegriffe', included: true },
          { label: 'Eigene Seiten für Ihre Automarken', included: true },
          { label: 'Maximale Sichtbarkeit in Ihrer Stadt', included: true },
          { label: 'Kundenbewertungen automatisch sammeln', included: true },
        ],
      },
      {
        ...
        title: 'Hilfe & Pflege',
        items: [
          { label: '1 Jahr bevorzugte Betreuung', included: true },
          { label: 'Online-Schaltung & Einrichtung', included: true },
          { label: 'Einweisung für Ihr Verkaufsteam', included: true },
          { label: 'Inkl. 6 Monate Pflege-Vertrag', included: true },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        title: 'Ihre Systeme angebunden',
        items: [
          { label: 'Mehrere Standorte verwalten', included: true },
          { label: 'Anbindung an Ihr Autohaus-System', included: true, detail: 'z.B. Loco-Soft, DAT' },
          { label: 'Gemeinsamer Fahrzeugbestand aller Filialen', included: true },
          { label: 'Getrennte Bereiche für jede Filiale', included: true },
        ],
      },
      {
        icon: <Bot size={16} />,
        title: 'Automatisch & Künstliche Intelligenz',
        items: [
          { label: 'KI-Chatbot beantwortet Kundenfragen', included: true },
          { label: 'Texte für Autos automatisch schreiben lassen', included: true },
          { label: 'Preise passen sich automatisch an', included: true },
          { label: 'Automatische Verkaufsabläufe', included: true },
        ],
      },
      {
        icon: <Target size={16} />,
        title: 'Massive Werbung',
        items: [
          { label: 'Sichtbar bei Google für 1000+ Begriffe', included: true },
          { label: 'Kunden gezielt zum Kauf führen', included: true },
          { label: 'Alte Besucher erneut mit Werbung ansprechen', included: true },
          { label: 'Website in mehreren Sprachen (für Export)', included: true },
        ],
      },
      {
        icon: <Palette size={16} />,
        title: 'Marke & Aussehen',
        items: [
          { label: 'Einheitliches, eigenes Marken-Design', included: true },
          { label: 'Auch für eingeschränkte Menschen nutzbar', included: true },
          { label: 'Vorab-Tests mit echten Nutzern', included: true },
          { label: 'Mehrere Automarken unter einem Dach', included: true },
        ],
      },
      {
        icon: <Headphones size={16} />,
        title: 'Premium Hilfe',
        items: [
          { label: 'Fester, persönlicher Ansprechpartner', included: true },
          { label: 'Garantierte, schnelle Hilfe bei Problemen', included: true },
          { label: '24/7 Notfall-Telefonnummer', included: true },
          { label: 'Wir verbessern die Seite durchgehend', included: true },
        ],
      },
    ],
  },
...
const COMPARISON_ROWS: ComparisonRow[] = [
  { feature: 'Modernes Autohaus-Design', category: 'Aussehen', tier1: true, tier2: true, tier3: true },
  { feature: 'Design-Vorschläge', category: 'Aussehen', tier1: '1', tier2: '3', tier3: 'Unbegrenzt' },
  { feature: 'Fließende Bewegungen', category: 'Aussehen', tier1: false, tier2: true, tier3: true },
  { feature: 'Eigenes Firmen-Design', category: 'Aussehen', tier1: false, tier2: false, tier3: true },
  { feature: 'Eigene Seiten pro Fahrzeug', category: 'Für Autohändler', tier1: true, tier2: true, tier3: true },
  { feature: 'Fahrzeug-Suche', category: 'Für Autohändler', tier1: 'Einfach', tier2: 'Erweitert', tier3: 'Premium' },
  { feature: 'Probefahrt Anfragen', category: 'Für Autohändler', tier1: true, tier2: true, tier3: true },
  { feature: 'Inzahlungnahme Anfragen', category: 'Für Autohändler', tier1: 'Einfach', tier2: 'Schritt-für-Schritt', tier3: 'Mit Live-Preisen' },
  { feature: 'Finanzierungs-Rechner', category: 'Für Autohändler', tier1: false, tier2: true, tier3: true },
  { feature: 'Fahrzeug-Merkliste', category: 'Für Autohändler', tier1: false, tier2: true, tier3: true },
  { feature: 'Mobile.de Anbindung', category: 'Technik', tier1: 'Handarbeit', tier2: 'Automatisch', tier3: 'Sofort-Abgleich' },
  { feature: 'Anbindung an Händler-System', category: 'Technik', tier1: false, tier2: false, tier3: true },
  { feature: 'Kundenverwaltung', category: 'Technik', tier1: false, tier2: 'Standard', tier3: 'Komplett' },
  { feature: 'Mehrere Standorte / Filialen', category: 'Technik', tier1: false, tier2: false, tier3: true },
  { feature: 'Anzahl der Webseiten', category: 'Inhalt', tier1: '5–8', tier2: '15–30', tier3: 'Unbegrenzt' },
  { feature: 'Autotexte vom Computer geschrieben', category: 'Inhalt', tier1: false, tier2: false, tier3: true },
  { feature: 'Regionale Google-Sichtbarkeit', category: 'Werbung', tier1: 'Einfach', tier2: 'Sehr stark', tier3: 'Auf alle Städte' },
  { feature: 'Anzahl der Suchbegriffe', category: 'Werbung', tier1: 'Die Wichtigsten', tier2: 'Ca. 50 Begriffe', tier3: 'Über 1000 Begriffe' },
  { feature: 'Extra Google-Sichtbarkeit für Autos', category: 'Werbung', tier1: false, tier2: true, tier3: true },
  { feature: 'Testen, was mehr verkauft', category: 'Verkaufshilfen', tier1: false, tier2: true, tier3: true },
  { feature: 'Automatischer Verkaufsablauf', category: 'Verkaufshilfen', tier1: false, tier2: false, tier3: true },
  { feature: 'Hilfe nach Fertigstellung', category: 'Betreuung', tier1: '3 Monate', tier2: '12 Monate', tier3: '12 Monate Chefbehandlung' },
];
...
const CASE_STUDIES: CaseStudy[] = [
  ...
  },
  {
    ...
    tier: 'Profi-Händler',
    stats: [
      { label: 'Besucherzahlen', value: '+340%' },
      { label: 'Mehr Anfragen', value: '+220%' },
      { label: 'Geld wieder reingeholt nach', value: '6 Monaten' },
    ],
    description:
      'Kompletter Neustart mit automatischer mobile.de-Verbindung und starker Google-Sichtbarkeit vor Ort. Sie stehen jetzt auf Platz 1 für 42 wichtige Suchbegriffe.',
  },
  {
    title: 'Autogruppe Rhein-Main',
    tier: 'Mehrere Standorte',
    stats: [
      { label: 'Standorte verbunden', value: '7' },
      { label: 'Automatische Anfragen', value: '89%' },
      { label: 'Zeitersparnis pro Woche', value: '18h' },
    ],
    description:
      'Alle 7 Standorte wurden an ein einziges System angeschlossen. Autos synchronisieren sich von alleine über alle Filialen hinweg und ein KI-Roboter beantwortet erste Fragen.',
  },
];

const FAQ_ITEMS: FAQItem[] = [
  {
    question: 'Was ist im Festpreis alles mit drin?',
    answer:
      'Alles von der ersten Idee über das Design, das Programmieren, die Texte bis hin zur Freischaltung im Internet. Es gibt keine versteckten Kosten. Nur Server-Kosten, Ihre Internetadresse und wenn Sie möchten ein Pflege-Vertrag, werden extra abgerechnet.',
  },
  {
    question: 'Wem gehört die Webseite, wenn sie fertig ist?',
    answer:
      'Ihnen zu 100 %. Sobald die Rechnung bezahlt ist, gehört der gesamte Code und das Design Ihnen. Sie können jederzeit zu einer anderen Agentur wechseln, niemand sperrt Sie ein.',
  },
  {
    question: 'Was ist, wenn ich später etwas ändern möchte?',
    answer:
      'Kleine Anpassungen in den ersten Monaten sind bei uns immer mit drin. Danach können wir gerne einen festen Pflege-Vertrag vereinbaren, oder Sie zahlen einfach nur das, was wir auch wirklich für Sie tun (nach Stundenaufwand).',
  },
  {
    question: 'Wann und wie muss ich bezahlen?',
    answer:
      'Ganz normal in drei Schritten: 40 % zu Beginn, 30 % wenn Ihnen das Design gefällt, und die restlichen 30 % erst dann, wenn die Seite online geht.',
  },
  {
    question: 'Ich nutze schon ein System (wie WordPress), kann ich das behalten?',
    answer:
      'Ja, ab Stufe 02 können wir Ihr bestehendes System (wie WordPress) problemlos im Hintergrund weiterlaufen lassen, während vorne alles neu und modern aussieht.',
  },
  {
    question: 'Wie lange dauert das Ganze?',
    answer:
      'Ein kleines Paket dauert meist 3–5 Wochen. Das mittlere Paket etwa 6–10 Wochen. Es hängt immer ein bisschen davon ab, wie schnell Sie uns Bilder oder Feedback geben können.',
  },
  {
    question: 'Helft ihr mir auch danach, weiter oben bei Google zu stehen?',
    answer:
      'Ja! Wenn Sie wollen, arbeiten wir jeden Monat weiter an Ihrer Seite, damit Sie bei Google immer weiter nach oben klettern. Dafür gibt es ein extra Zusatz-Paket.',
  },
  {
    question: 'Warum seid ihr besser als eine normale Werbeagentur?',
    answer:
      'Bei uns sprechen Sie direkt mit den Leuten, die die Seite auch bauen. Kein Verkäufer dazwischen, der Dinge verspricht, die nicht gehen. Das macht es günstiger, schneller und das Ergebnis ist am Ende deutlich besser.',
  },
  {
    question: 'Kann ich später auf ein größeres Paket umsteigen?',
    answer:
      'Natürlich. Sie können klein anfangen und wenn Ihr Geschäft wächst, erweitern wir das System. Alles, was Sie schon bezahlt haben, wird dabei fair angerechnet.',
  },
  {
    question: 'Was passiert, wenn mir das Design nicht gefällt?',
    answer:
      'Wir haben eine Zufriedenheits-Garantie: Wenn Ihnen unsere ersten Design-Vorschläge absolut nicht gefallen, brechen wir ab und Sie bezahlen nur die Anzahlung. So haben Sie kein großes Risiko.',
  },
];
...
const DECISION_HELPERS: DecisionHelper[] = [
  {
    id: 'essential',
    title: 'Ich brauche eine neue Webseite',
    subtitle: 'Solide & Professionell starten',
    ideal: 'Für kleine Autohäuser & Einzelstandorte',
    icon: <Globe size={24} />,
  },
  {
    id: 'growth',
    title: 'Ich will mehr Autos verkaufen',
    subtitle: 'Wachstum auf Autopilot',
    ideal: 'Für etablierte Händler, die wachsen wollen',
    icon: <TrendingUp size={24} />,
  },
  {
    id: 'enterprise',
    title: 'Ich habe mehrere Filialen',
    subtitle: 'Arbeitsschritte automatisieren',
    ideal: 'Große Autohaus-Gruppen',
    icon: <Layers size={24} />,
  },
];
